...
// Mocks
import { MockFillableDirectSettlementModule } from "@mocks/modules/MockFillableDirectSettlementModule.sol";

// Test
import { Base_Test } from "@test/Base.t.sol";

abstract contract FillableDirectSettlementModule_Test is Base_Test {
    /*//////////////////////////////////////////////////////////////
                                VARIABLES
    //////////////////////////////////////////////////////////////*/

    /// @dev MockFillableDirectSettlementModule contract
    MockFillableDirectSettlementModule public module;
    ...
    function setUp() public virtual override {
        ...
        // Deploy module
        module = new MockFillableDirectSettlementModule("Direct Settlement Module", "1.0.0", address(portikusV2));
