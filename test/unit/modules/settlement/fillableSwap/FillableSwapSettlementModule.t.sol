...
import { MockFillableSwapSettlementModule } from "@mocks/modules/MockFillableSwapSettlementModule.sol";

// Test
import { Base_Test } from "@test/Base.t.sol";

abstract contract FillableSwapSettlementModule_Test is Base_Test {
    /*//////////////////////////////////////////////////////////////
                                VARIABLES
    //////////////////////////////////////////////////////////////*/

    /// @dev MockFillableSwapSettlementModule contract
    MockFillableSwapSettlementModule public module;
    ...
    function setUp() public virtual override {
        ...
        // Deploy module
        module = new MockFillableSwapSettlementModule("Swap Settlement Module", "1.0.0", address(portikusV2));
        // Deploy executor
